...
# Template: app
# Command: C:\Qt\5.9.1\mingw53_32\bin\qmake.exe -o Makefile OscarEOsAlho.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
#############################################################################
...
Makefile: OscarEOsAlho.pro ../../../../Qt/5.9.1/mingw53_32/mkspecs/win32-g++/qmake.conf ../../../../Qt/5.9.1/mingw53_32/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -o Makefile OscarEOsAlho.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
